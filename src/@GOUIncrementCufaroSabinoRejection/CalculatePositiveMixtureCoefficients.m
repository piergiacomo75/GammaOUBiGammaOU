%' CalculatePositiveMixtureCoefficients
%'
%' Calculate the positive coefficients of the formal mixture
%'
...
function positiveCoefficients = CalculatePositiveMixtureCoefficients(a, shape, numCoefficients)

  mixtureCoefficients = GOUIncrementCufaroSabinoRejection.CalculateMixtureCoefficients(a, shape, numCoefficients);
  positiveCoefficients = max(mixtureCoefficients, 0);
